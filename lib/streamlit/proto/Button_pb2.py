...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _BUTTON.fields_by_name['use_container_width']._options = None
  _BUTTON.fields_by_name['use_container_width']._serialized_options = b'\030\001'
  _BUTTON._serialized_start=33
  _BUTTON._serialized_end=222
