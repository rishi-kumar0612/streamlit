...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _ARROW.fields_by_name['width']._options = None
  _ARROW.fields_by_name['width']._serialized_options = b'\030\001'
  _ARROW.fields_by_name['height']._options = None
  _ARROW.fields_by_name['height']._serialized_options = b'\030\001'
  _ARROW.fields_by_name['use_container_width']._options = None
  _ARROW.fields_by_name['use_container_width']._serialized_options = b'\030\001'
  _ARROW._serialized_start=32
  _ARROW._serialized_end=625
  _ARROW_EDITINGMODE._serialized_start=391
  _ARROW_EDITINGMODE._serialized_end=443
  _ARROW_SELECTIONMODE._serialized_start=445
  _ARROW_SELECTIONMODE._serialized_end=561
  _ARROW_BORDERMODE._serialized_start=563
  _ARROW_BORDERMODE._serialized_end=610
  _STYLER._serialized_start=627
  _STYLER._serialized_end=706
